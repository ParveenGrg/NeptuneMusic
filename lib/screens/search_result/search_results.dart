...
import 'package:neptune_music/utils/recent_search.dart';
                            ...
                            return InkWell(
                              onTap: () {
                                ...
                                box.put(state.songs[i].songname, {
                                  ...
                                  "username": state.songs[i].artistid,
                          ...
                          itemBuilder: (context, i) {
                            return InkWell(
                              onTap: () {
                                FocusScope.of(context).unfocus();
                                var box = Hive.box('Recentsearch');
                                box.put(state.artists[i].name, {
                                  "songname": state.artists[i].name,
                                  "fullname": state.artists[i].artistname,
                                  "username": '',
                                  "cover": state.artists[i].avatar,
                                  "track": '',
                                  "id": '',
                                  "type": "ARTIST"
                                });
                                ...
                                child: Row(
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        imageUrl: state.artists[i].avatar!,
                                        width: 50,
                                        height: 50,
                                        progressIndicatorBuilder:
                                            (context, url, l) =>
